"""ref. https://medium.com/codex/aes-how-the-most-advanced-encryption-actually-works-b6341c44edb9"""
# https://en.wikipedia.org/wiki/AES_key_schedule
# https://csrc.nist.gov/files/pubs/fips/197/final/docs/fips-197.pdf
# for understanding math behind s-box calculations : https://en.wikipedia.org/wiki/Rijndael_S-box
# AES 128 Encryption solved example: https://www.kavaliro.com/wp-content/uploads/2014/03/AES.pdf
...
# def sub_byte_row(a):
#     for i in range(4):
#         # Ensure that a[i] is a valid hex string
#         row = a[i]
#         if len(row) == 4:
#             a[i] = hex(data[int(row[2], 16)][int(row[3], 16)])
#     return a
...
def sub_byte(a) -> list:
    ''' for a matrix, s-box substitution '''
    for i in range(4):
        for j in range(4):
            value = int(a[i][j], 16)
            a[i][j] = hex(data[value // 16][value % 16])
    return a
